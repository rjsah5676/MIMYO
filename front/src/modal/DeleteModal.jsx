...
function DeleteModal() {
    ...
    const modal_name = useRef('delete-modal');
    ...
    const doDel = () => {
        dispatch(setModal({...modalSel, delCheck:modalSel.selected.split('-')[0], isOpen:false}));
    }
    ...
    return (
        <>
            ...
            <div className="deletemodal-content">
                <div className="deletemodal-text">정말 삭제하시겠습니까?</div>
                <div className="deletemodal-buttons">
                <button className="deletemodal-btn delete" onClick={doDel}>삭제</button>
                <button className="deletemodal-btn cancel" onClick={modalClose}>취소</button>
                </div>
            </div>
            </div>
        </>
